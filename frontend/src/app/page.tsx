          ...
          <div className="flex flex-col items-center space-y-6 text-center">
            <div className="space-y-4 animate-fade-in-up">
              ...
              <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl animate-fade-in-up animation-delay-200">
                Smart Giving
                <span className="text-primary bg-gradient-to-r from-primary to-primary/80 bg-clip-text text-transparent animate-gradient"> Made Simple</span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up animation-delay-600">
              <Link
                ...
                <span className="transition-transform duration-300 group-hover:translate-x-1">Start Your Philanthropy Journey</span>
              </Link>
              <Link
                href="#how-it-works"
                ...
                <span className="transition-transform duration-300 group-hover:translate-x-1">See How It Works</span>
              </Link>
            </div>
          </div>
        </div>
          ...
          <div className="mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:max-w-[80rem]">
            <div className="group flex flex-col items-center space-y-4 text-center transition-all duration-300 hover:scale-105 hover:shadow-lg p-6 rounded-lg">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-bold transition-colors duration-300 group-hover:text-primary">Discover Your Values</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  We explore what matters most to you—location, causes, 
                  and the type of impact you want to create.
                </p>
              </div>
            </div>
            ...
            <div className="group flex flex-col items-center space-y-4 text-center transition-all duration-300 hover:scale-105 hover:shadow-lg p-6 rounded-lg">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-bold transition-colors duration-300 group-hover:text-primary">Systematic Search</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="group flex flex-col items-center space-y-4 text-center transition-all duration-300 hover:scale-105 hover:shadow-lg p-6 rounded-lg">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-bold transition-colors duration-300 group-hover:text-primary">Curated Recommendations</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="group flex flex-col items-center space-y-4 text-center transition-all duration-300 hover:scale-105 hover:shadow-lg p-6 rounded-lg">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-bold transition-colors duration-300 group-hover:text-primary">Strategic Giving</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Receive specific grant recommendations and strategies 
            ...
            <div className="flex flex-col justify-center space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-400">
                  Without professional guidance, most people rely on random charity 
                  directories or emotional appeals. The wealthy hire advisors who 
                  use systematic approaches to maximize impact.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">No systematic evaluation of impact or alignment</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Giving based on appeals rather than evidence</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Systematic discovery and evidence-based recommendations</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="bg-muted py-16 md:py-24">
        <div className="container px-4 md:px-6">
          <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center mb-16">
            ...
            <p className="max-w-[85%] text-gray-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
              The same capabilities that wealthy philanthropists pay $200K/year for, 
          ...
          <div className="mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 md:max-w-[64rem]">
            <div className="group flex flex-col items-center space-y-4 border rounded-lg p-8 shadow-sm bg-white transition-all duration-300 hover:scale-105 hover:shadow-xl hover:border-primary/20">
              ...
              <h3 className="text-xl font-bold text-center transition-colors duration-300 group-hover:text-primary">Personalized Discovery</h3>
              <p className="text-sm text-gray-600 text-center dark:text-gray-400">
                AI-driven conversation that explores your values, location preferences, 
                and impact goals to create your unique philanthropic profile.
              </p>
            </div>
            ...
            <div className="group flex flex-col items-center space-y-4 border rounded-lg p-8 shadow-sm bg-white transition-all duration-300 hover:scale-105 hover:shadow-xl hover:border-primary/20">
              ...
              <h3 className="text-xl font-bold text-center transition-colors duration-300 group-hover:text-primary">Evidence-Based Matching</h3>
              <p className="text-sm text-gray-600 text-center dark:text-gray-400">
                Systematic evaluation of thousands of organizations using impact data, 
                transparency scores, and alignment with your specific criteria.
              </p>
            </div>
            ...
            <div className="group flex flex-col items-center space-y-4 border rounded-lg p-8 shadow-sm bg-white transition-all duration-300 hover:scale-105 hover:shadow-xl hover:border-primary/20">
              ...
              <h3 className="text-xl font-bold text-center transition-colors duration-300 group-hover:text-primary">Strategic Grant Recommendations</h3>
              <p className="text-sm text-gray-600 text-center dark:text-gray-400">
